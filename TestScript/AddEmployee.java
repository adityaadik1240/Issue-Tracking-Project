...
public class AddEmployee {
		 ...
		 WebDriver driver;
		    ...
		    public void tearDown() throws InterruptedException {
		        ...
		        driver.findElement(By.id("email")).sendKeys("aditya002@gmail.com");
		        driver.findElement(By.xpath("//*[@id=\"roles\"]")).sendKeys("Employee");
		        driver.findElement(By.name("username")).sendKeys("aditya1111");
		       ...
		       driver.findElement(By.xpath("//*[@id=\"root\"]/div/form/div[14]/div/input")).sendKeys("aditya@gmail.com");
		       driver.findElement(By.xpath("//*[@id=\"root\"]/div/form/div[15]/div/input")).sendKeys("aditya@whitetabletech.com");
		      ...
		      // driver.switchTo().frame(0);
		       ...
		       driver.findElement(By.xpath("/html/body/div/div/form/div[18]/div/input")).sendKeys("2022-03-11");
		        ...
		        driver.findElement(By.id("photo")).sendKeys("C:\\Users\\Icon\\Music\\linkedin photo.jpeg");
		      //  driver.findElement(By.xpath("/html/body/div/div/form/div[20]/button")).click();
		        
		     //  Thread.sleep(2000);
		        
		        WebElement submitButton = driver.findElement(By.xpath("/html/body/div/div/form/div[20]/button"));
		       ...
		       // driver.findElement(By.xpath("/html/div/div/form/div[20]/button")).click();
